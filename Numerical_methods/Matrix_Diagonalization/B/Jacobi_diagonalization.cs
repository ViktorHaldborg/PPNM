...
public class JacobiDiagonalizationVBV{

public static int JacobiDiag(matrix A, vector e, matrix V, int o){
...
A[p,q]=0;A[p,p]=a_pp1; A[q,p]=A[p,q]; // Overwrite wrongly defined elements from above loop
