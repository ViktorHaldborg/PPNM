...
double a=1; double b=3; // Declare interval of randomly generated entries
...
do{
	...
	for(int i=0; i<n; i=i+1)
	{
		...
		{
			e[i,0]=0; 
			u[i,0]=RandomDouble(1,3);  // Elements of e(p) and u (do not run over 0 here as per assumption)
		}
