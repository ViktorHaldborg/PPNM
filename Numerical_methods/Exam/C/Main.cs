...
int ε=9; // Required decimals of precision in the gradient
int μ=3; // Desired decimals of precision in comparison of results
int Points=1000; // Resolution (lower for computation time, but it compromises stability)
int n=RandomInt(4,8); // Determine dimensionality (of modest size)
