...
B.set_identity(); // Initial zero't approximation to H
double EPS=4.0/4194304;
...
{	
	...
	{
		λ=λ*0.99; s=λ*δx; // Gentler backtracking
	...
	if(Abs(u.dot(y))>10e-9) 
	{
		B=B+δB;
	}

	x=x+s;
if(Counter >100000){Error.WriteLine("No or slow divergence: Program terminated after {Counter} steps"); break;}
